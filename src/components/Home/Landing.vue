                ...
                <article class="hero-enter journey-card-stitch relative bg-surface-container-lowest border border-card-border rounded-[32px] p-6 sm:p-8 shadow-card overflow-hidden" style="--hero-delay: 320ms">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="absolute left-[23px] top-6 bottom-6 w-[2px] bg-primary/30 rounded-full overflow-hidden" aria-hidden="true">
                            <!-- Creative flowing energy light beam pulse -->
                            <div class="timeline-laser-pulse" />
                        </div>
...
.timeline-laser-pulse {
    ...
    width: 100%;
    height: 45%;
    background: linear-gradient(180deg, transparent, var(--color-primary) 50%, var(--color-on-primary) 80%, transparent);
    animation: timeline-flow 3.5s cubic-bezier(0.4, 0, 0.2, 1) infinite;
}
